"""
Simple PDF form helper:
 - list_form_fields(pdf_path): list all fields and their options (if any)
 - fill_pdf_from_json(pdf_path, json_or_dict, output_path): fill from JSON/dict
 - example(): tiny demo
"""
